            ...
            api.createWidget("banner-button-container-widget", {
                ...
                buttonPressed(button) {
                    if (button == "close") {
                        ...
                        toggleState =
                            toggleState === "expanded" ? "collapsed" : "expanded";
                        ...
                        if (cookieExpDate) {
                            ...
                            if (cookie("banner_collapsed")) {
                                ...
                                bannerState.collapsed =
                                    bannerState.collapsed == "false" ? "true" : "false";
                            } else {
            ...
            api.createWidget("banner-column-icon", {
                ...
                html(attrs) {
                    ...
                    if (columnIcon.includes("http") || columnIcon.includes("/uploads/")) {
                        ...
                        let convertedIcon = convertIconClass(columnIcons[attrs.column]);
                        return iconNode(convertedIcon);
                    }
                },
            });
